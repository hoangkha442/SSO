              ...
              {groupsData.map((group, index) => (
                <tr key={index} className='px-5'>
                  <td className="whitespace-nowrap text-xs sm:text-base md:text-lg font-medium text-[#344054] h-full py-0 pl-5">
                    <div className='bg-[#fccac9] pl-2 h-[60px] md:h-[80px] leading-[60px] md:leading-[80px]'>{group.name}</div>
                  </td>
                  <td className="whitespace-nowrap text-xs sm:text-base md:text-lg font-medium text-[#344054] h-full py-0 pl-2">
                    <div className='bg-[#fccac9] pl-2 h-[60px] md:h-[80px] leading-[60px] md:leading-[80px]'>{group.field1}</div>
                  </td>
                  <td className="whitespace-nowrap text-xs sm:text-base md:text-lg font-medium text-[#344054] h-full py-0 pl-2">
                    <div className='bg-[#fccac9] pl-2 h-[60px] md:h-[80px] leading-[60px] md:leading-[80px]'>{group.field2}</div>
                  </td>
                  <td className="whitespace-nowrap text-xs sm:text-base md:text-lg font-medium text-[#344054] h-full py-0 pl-2">
                    <div className='bg-[#fccac9] pl-2 h-[60px] md:h-[80px] leading-[60px] md:leading-[80px]'>{group.field3}</div>
                  </td>
                  <td className="whitespace-nowrap text-xs sm:text-base md:text-lg font-medium text-[#344054] h-full py-0 pl-2">
                    <div className='bg-[#fccac9] pl-2 h-[60px] md:h-[80px] leading-[60px] md:leading-[80px]'>{group.field4}</div>
                  </td>
