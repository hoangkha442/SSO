...
import SessionTable from './SessionTable'; // Import SessionTable
    ...
    <section className='px-4 py-6 sm:px-8 sm:py-8'>
      ...
      <div className="bg-white border border-[#D0D3D9] rounded-xl mt-5 p-6 sm:p-9">
        <div className="flex items-center gap-2 cursor-pointer mb-10" onClick={() => { navigate('/admin/users') }}>
          ...
          <p className='text-xl sm:text-2xl font-semibold text-[#344054]'>anhTT</p>
        </div>
        <div className="flex mb-9">
          <button
            className={`px-4 py-2 text-2xl border border-[#D0D5DD] rounded-tl-lg rounded-bl-lg ${activeTab === 'details' ? 'text-[#FCFCFC] bg-[#009FF5]' : 'text-[#344054]'}`}
            onClick={() => setActiveTab('details')}
          >
            Details
          </button>
          <button
            className={`px-4 py-2 text-2xl border-y border-r border-[#D0D5DD] ${activeTab === 'roleMapping' ? 'text-[#FCFCFC] bg-[#009FF5]' : 'text-[#344054]'}`}
            onClick={() => setActiveTab('roleMapping')}
          >
            Role Mapping
          </button>
          <button
            className={`px-4 py-2 text-2xl border-y border-r border-[#D0D5DD] ${activeTab === 'groups' ? 'text-[#FCFCFC] bg-[#009FF5]' : 'text-[#344054]'}`}
            onClick={() => setActiveTab('groups')}
          >
            Groups
          </button>
          <button
            className={`px-4 py-2 text-2xl border-y border-r border-[#D0D5DD] rounded-tr-lg rounded-br-lg ${activeTab === 'session' ? 'text-[#FCFCFC] bg-[#009FF5]' : 'text-[#344054]'}`}
